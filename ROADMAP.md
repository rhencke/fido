...
| C9 | C8 | **Functions and activations.** Function types, declarations and literals, callable expression heads, parameters and results, multi-results, calls and returns, closures, activation environments, `defer`/`panic`/`recover`; the iterator-function range domain. | One activation and call authority extending the same application and control roots. | `milestone=C9` (24 + 15) | SC-03…SC-07, SC-09, SC-15…SC-17, SC-20…SC-22; gate LAT-171 |
