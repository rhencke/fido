(** ============================================================================
    ...
    Physical split (ARCHITECTURE.md §3a, in progress): the pure fold/float layer (box/render, the
    const-op layer, [fsf_checked]/[floats_checked], the dyadic↔SF* arc) lives in GoSemCore.v,
    re-exported here; [eval_value] + its [Local] core stay HERE with the proofs that compute
    through them (a public core would bypass the float boundary — negtest-sealed).
    ============================================================================ *)
