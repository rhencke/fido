(** ============================================================================
    ...
    Physical split (ARCHITECTURE.md §3a, in progress): the value core ([eval_value]/[fsf_checked]/
    box/render/const-op layer) + the dyadic↔SF* arc live in GoSemCore.v, re-exported here.
    ============================================================================ *)
