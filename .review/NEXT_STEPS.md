...
- **Active checkpoint:** C4 retained-phase and scope-ledger repair 4 — replace the raw-map "proof-beside-the-path"
  root with ONE retained `CompilationInput` → typed work layer → `TypeNameFactTable` (built from the exact input,
