...
`M1 → M2 → M3 → Rob approves the exact M4 plan → M4 → checkpoint-definition Step 0 → C5`.

M2 through M4 and C5 remain forbidden until Rob accepts M1.
