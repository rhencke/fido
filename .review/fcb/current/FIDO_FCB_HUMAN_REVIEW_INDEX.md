...
| `C4-REVIEW` | **PENDING** | Review the exact C4 candidate named by .review/NEXT_STEPS.md, and accept or block it. Only Rob accepts C4. | .review/NEXT_STEPS.md and the main review thread | Until Rob accepts C4, C5, checkpoint-definition Step 0 and M1-M4 implementation remain forbidden. |
