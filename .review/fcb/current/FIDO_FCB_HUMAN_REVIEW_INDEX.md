...
|---|---|---|---|---|
| `C4-REVIEW` | **BLOCKED / AWAITING REPAIR-15 CANDIDATE** | Review the next C4 candidate only after intrinsic retained elaboration repair 14 is implemented and frozen. The A005 migration candidate `20c5ad5c499d5046563471624117b80c737c7157` is BLOCKED, not accepted: A005's first implementation is incomplete, the retained core still recomputes package facts / layout / plan / diagnostics, and the public failure discards the exact rejected core. Repair 15 is the sole active C4 work and subsumes repair 14. | `.review/C4_IMPLEMENTATION_REPAIR_15.md`, A001, A005, and the main review thread | C5 and post-C4 feature work remain forbidden. |
