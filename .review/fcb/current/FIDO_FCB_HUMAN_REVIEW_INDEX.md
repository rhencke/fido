...
| `M2-REVIEW` | **PENDING** | Review the exact M2 candidate named by .review/NEXT_STEPS.md, and accept or block it. Only Rob accepts M2. | .review/NEXT_STEPS.md and the main review thread | Until Rob accepts M2, M3 and M4 implementation and C5 remain forbidden. |
