...
|---|---|---|---|---|
| `C4-REVIEW` | **BLOCKED — awaiting the repair-17 candidate** | Candidate `12b1bc998a8a2a6b5ecd2360d734f7e2d56eac7c` is BLOCKING, the eighteenth to block; `c8ce2d8c6ad1c109c08c44b689b70abbb408ed7a` is its documentation-only freeze. Repair 16 made real progress and did NOT close C4: the returned-object fixtures omitted the retained causal history, the naming gate was still false-green for upper-case record fields and silently skipped unreadable text, `Emit.Image` kept a public raw constructor against Charter §22, and the coarse legacy result peer survived. **Repair 17 is the sole active C4 work.** One of its findings is blocked on a human decision — see `.review/OPEN_QUESTIONS.md` Q-08. C4 is NOT accepted; only Rob accepts it. | `.review/C4_IMPLEMENTATION_REPAIR_17.md`, A001, A005, and the main review thread | C5, post-C4 features, the broad source cleanup and proof-module partitioning remain forbidden. |
