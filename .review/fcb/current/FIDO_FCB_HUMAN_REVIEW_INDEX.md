...
| `C4-REVIEW` | **BLOCKED** | Rob will review the repair-19 candidate after it is frozen. Candidate 50c3bcc5b8eb2e47074352f5c9f0124e71509396 is BLOCKING — the twentieth blocked C4 implementation candidate. No review is requested while repair 19 is active. Only Rob accepts C4. | .review/NEXT_STEPS.md, the repair-19 directive, and the main review thread | C5, checkpoint-definition Step 0, post-C4 features, the broad source cleanup and proof-module partitioning remain forbidden. |
