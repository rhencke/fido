...
| `M3-REVIEW` | **PENDING** | Review the exact M3 candidate named by .review/NEXT_STEPS.md, and accept or block it. Only Rob accepts M3. | .review/NEXT_STEPS.md and the main review thread | Until Rob accepts M3, M4 implementation and C5 remain forbidden; M4 additionally needs its own plan approval. |
