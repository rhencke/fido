...
> **Supersedes:** `FIDO_FCB_FIXED_POINTS_v2.md`  
...
| ARCH-03 | static-capability-provenance | `FIDO_FCB_ARCHITECTURE_CHARTER_v1.md` | `FIDO_FCB_ARCHITECTURE_CHARTER_v3.md` | `markdown-section: `## 4. \`CompilableProgram\` Is the Static Capability`` | `normalized-section-text` |
