# Fido FCB Checkpoint Authoring Guide v2
...
> **Supersedes:** `FIDO_FCB_CHECKPOINT_AUTHORING_GUIDE_v1.md`  
...
1. regenerate every affected FCB document;
2. bump each changed FCB version;
3. update the Index and manifest hashes;
4. replace the FCB set in the ChatGPT and Claude project libraries;
5. delete every stale version;
6. record the accepted repo SHA and bundle hash in every banner.
