...
> **Supersedes:** `FIDO_FCB_ROADMAP_v1.md`  
...
Repository basis `ece4c1dd0797eff6e9ebdd5d77a0e59f1c9e76e0` is a later documentation/campaign commit and is not a new implementation candidate.
...
**Exit condition:** All frozen public additions and theorem statements pass the checkpoint contract; production uses only the new path; paired fixtures and replay gates pass; Rob accepts; affected FCB files regenerate and stale copies are deleted.
