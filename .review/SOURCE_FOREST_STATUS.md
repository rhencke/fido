...
- FOURTH FINAL review (`task-mrrnyaen`, non-stale 2026-07-19) found the §22/§23 fixtures materially WEAKER than
  ...
  `float64(int(5))`.
- Status: **C3 FINAL barrier — all defects from ALL FOUR FINAL reviews CLOSED @`359f2f2`; one-pass hot path +
  ...
  suite all proved + gated (529/529); `make check` green on the working tree; generated bytes byte-identical
  throughout.  Awaiting the FINAL Codex re-review.**
