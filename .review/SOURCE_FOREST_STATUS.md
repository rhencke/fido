...
- Contract activation SHA: **this commit** (`milestone(contract): C2 — activate production occurrence index
  and indexed traversal`).  This directive (`.review/C2_PRODUCTION_GOINDEX_PLAN.md` = `.review/NEXT_STEPS.md`)
  is the binding C2 completion contract.
- Status: **activation** — implementation not yet begun.
