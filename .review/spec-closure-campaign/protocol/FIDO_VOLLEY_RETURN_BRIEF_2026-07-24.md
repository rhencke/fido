...
**Date:** 2026-07-24  
**Reviewed artifact:** `FIDO_TERMINAL_CORRECTNESS_DIRECTIVE.md`  

**Amended artifact:** `FIDO_TERMINAL_CORRECTNESS_DIRECTIVE.md`  
...
FIDO_TERMINAL_CORRECTNESS_DIRECTIVE.md: OK
FIDO_VOLLEY_PROTOCOL_SAFETIES.md: OK
FIDO_VOLLEY_ADJUDICATION_BRIEF_2026-07-24.md: OK
README.md: OK
tools/lint_directive.py: OK
tools/validate_return.py: OK

$ sha256sum FIDO_TERMINAL_CORRECTNESS_DIRECTIVE.md
428c609766f08025686580ab88fa25c02e06fb339629c10ec6023ed9c77d7540  FIDO_TERMINAL_CORRECTNESS_DIRECTIVE.md
```

### Amended directive lint

```text
$ python3 tools/lint_directive.py FIDO_TERMINAL_CORRECTNESS_DIRECTIVE.md
LINT CLEAN — FIDO_TERMINAL_CORRECTNESS_DIRECTIVE.md
```
