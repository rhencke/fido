...
# the dune-build Print Assumptions surfaces (gosem_trust_surface, the bridge surfaces; the spine has separate
# printer/emit gates — PROGRESS.md "Current gates") + axiom-authority-selftest.sh pins completeness.  A
# source-text axiom-vernacular grep was tried here and DELETED — legal forms ([Local Axiom], …) bypass it.
