...
(* a bare float evaluates to a float64 runtime value, and an exact float-to-int constant to that integer *)
...
(* constant underflow produces positive zero at runtime *)
