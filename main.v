...
#[local] Instance StructRepOf_Big64 : StructRepOf Big64 := {|
  ...
  srep_rep := @mkSR Big64 ((GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: (GoI64 : Type) :: (bool : Type) :: (GoFloat64 : Type) :: (GoString : Type) :: nil) (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, (TI64, (TBool, (TFloat64, (TString, tt))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
                ...
                (fun t => MkBig64 (fst t) (fst (snd t)) (fst (snd (snd t))) (fst (snd (snd (snd t)))) (fst (snd (snd (snd (snd t))))) (fst (snd (snd (snd (snd (snd t)))))) (fst (snd (snd (snd (snd (snd (snd t))))))) (fst (snd (snd (snd (snd (snd (snd (snd t)))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd t))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd t)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
