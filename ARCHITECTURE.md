...
```text
[live]     No axioms in ANY module-level Print Assumptions cone (main_effect, gosem_trust_surface, the bridge surfaces, …). (axiom-manifest gate; pre-commit declaration tripwire)
