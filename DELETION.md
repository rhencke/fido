...
| Short declarations `x := e` | `vlet_demo`, locals uses everywhere | GoCompile `ScopeS` gate (admitted); denotation ABSENT (`shortdecl_supported_undenoted`) | partial | hold until the env statement layer denotes (plans/gosem-locals.md) |
