...
- RUNTIME tier next rules (`plans/runtime-value-tier.md`): runtime BOOL comparisons + map VALUES (R3
  LANDED — width conversions via `wrap_runint`); the GENERAL dyadic↔`SF*` theorem — each case shrinks the
