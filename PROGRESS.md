...
- Extend the cmd↔unified bridge to chan/heap/spawn (`plans/bridge-effects.md`; slice 1 LANDED — the calculus is value-parametric, embedding at `nat`, bridge at `GoAny`).
