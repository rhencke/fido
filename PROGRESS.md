...
over runtime locals, int/int64/uint64 literals, the bare int64/uint64 complement `^x`, and exactly two runtime
conversions — narrow→int64 widening `is_i64_of_narrow_ref` and float64→float32 narrowing
