...
- RUNTIME-tier arc R1–R5 COMPLETE for the current fragment (`plans/runtime-value-tier.md`; remaining
  absences: runtime floats/unary/`%`, the multi-byte rune); the GENERAL dyadic↔`SF*` theorem — each case shrinks the
