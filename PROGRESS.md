...
- RUNTIME-tier arc R1–R6 COMPLETE for the current fragment (`plans/runtime-value-tier.md`; remaining
  absences: runtime floats, platform-int `^` (no model op), the multi-byte rune); the GENERAL dyadic↔`SF*` theorem — each case shrinks the
