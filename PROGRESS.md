...
- RUNTIME tier next rule (`plans/runtime-value-tier.md`): runtime map VALUES (R4 LANDED — bool
  comparisons via `cmp_verdict`); the GENERAL dyadic↔`SF*` theorem — each case shrinks the
